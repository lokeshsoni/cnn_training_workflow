...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    # Lambda函数用以对上一层的输出施以任何Theano/TensorFlow表达式
...
model = yolo_body(Input(shape=(416, 416, 3)),5,80)
plot_model(model, 'architecture_yolo.png',show_shapes=True, show_layer_names=True)