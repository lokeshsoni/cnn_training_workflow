...
class DenseNet():
    @staticmethod
    def build(imagedims, nb_classes, depth=40, nb_dense_block=3, growth_rate=12,
              nb_filter=16, dropout_rate=None,weight_decay=1E-4, verbose=True):
        def conv_block(ip, nb_filter, dropout_rate=None, weight_decay=1E-4):
            ...
            x = Conv2D(nb_filter, 3, kernel_initializer="he_uniform", padding="same", use_bias=False,
        ...
        def transition_block(ip, nb_filter, dropout_rate=None, weight_decay=1E-4):
            ...
            x = Conv2D(nb_filter, 1, kernel_initializer="he_uniform", padding="same", use_bias=False,
        ...
        def create_dense_net(img_dim, nb_classes, depth, nb_dense_block, growth_rate, nb_filter, dropout_rate,
            ...
            # Initial convolution
            x = Conv2D(nb_filter, 3, kernel_initializer="he_uniform", padding="same", name="initial_conv2D", use_bias=False,
            ...
            return model
        return create_dense_net(imagedims, nb_classes, depth, nb_dense_block, growth_rate, nb_filter, dropout_rate,
                                weight_decay, verbose)
